...
Base.infer_effects(() -> res(Vector{Float64}(undef, 3)), ())
```
```{julia}
#| echo: true
#| code-line-numbers: "false"

Base.infer_effects(() -> res(Vector{Float64}(undef, 4)), ())
```
```{julia}
#| echo: true
#| code-line-numbers: "false"

Base.infer_effects(() -> res(FixedSizeVector{Float64}(undef, 3)), ())
```
```{julia}
#| echo: true
#| code-line-numbers: "false"

Base.infer_effects(() -> res(FixedSizeVector{Float64}(undef, 4)), ())
```
